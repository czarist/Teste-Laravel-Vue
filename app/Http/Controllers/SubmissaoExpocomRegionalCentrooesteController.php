...
class SubmissaoExpocomRegionalCentrooesteController extends Controller
{
    public function store(Request $request){
        ...
        try{
            ...
            $submissao = $user->regional_centrooeste->submissaoExpocom;
            ...
            if(!empty($submissao)){
                ...
                $coautores = CoauOriExpoSubCentrooeste::where('submissao_id', $submissao->id)->get();
            ...
            Log::info('User: '. Auth::user()->id . ' | Regional Centrooeste 2022 | Submeteu seu trabalho: ' . json_encode($post));
