...
class CreateSubmissaoRegionalSulsTable extends Migration
{
    public function up()
    {
        Schema::create('submissao_regional_suls', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('submissao_regional_suls');
    }
}
