...
class CreateSubmissaoExpocomRegionalSulsTable extends Migration
{
    public function up()
    {
        Schema::create('submissao_expocom_regional_suls', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('submissao_expocom_regional_suls');
    }
}
