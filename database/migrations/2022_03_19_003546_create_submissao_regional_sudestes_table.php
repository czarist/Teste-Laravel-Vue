...
class CreateSubmissaoRegionalSudestesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('submissao_regional_sudestes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('submissao_regional_sudestes');
    }
}
