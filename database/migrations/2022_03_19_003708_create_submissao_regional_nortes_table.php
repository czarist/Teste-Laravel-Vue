...
class CreateSubmissaoRegionalNortesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('submissao_regional_nortes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('submissao_regional_nortes');
    }
}
