...
class CreateSubmissaoRegionalCentrooestesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('submissao_regional_centrooestes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('submissao_regional_centrooestes');
    }
}
