...
class CreateDistribuicaoTipo123sTable extends Migration
{
    public function up()
    {
        Schema::create('distribuicao_tipo123s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('distribuicao_tipo123s');
    }
}
