<template>
    <div class="mt-5">
        <h5 class="col-12 d-flex justify-content-between">
            Lista de Trabalhos - Expocom {{ regiao_search ? regiao_search : '' }}
        </h5>
        <div class="col-12">
            <div class="card">
                        ...
                        <table class="table table-sm table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(registro, index) in registros" :key="index">
                                    ...
                                    <td class="align-middle text-center">{{ registro && registro.inscricao && registro.inscricao.user &&  registro.inscricao.user.indicacao && registro.inscricao.user.indicacao.categoria ? registro.inscricao.user.indicacao.categoria : "NI" }}</td>
...
<script>
    ...
    import GridMixin from '../../mixins/grid-mixin.js'
    ...
    export default {
        ...
        data() {
            return {
                value: 100,
                max: 100,
                page: this.regiao_id && this.regiao_id == null ? 'admin/lista-trabalho-expocom' 
                    : this.regiao_id && this.regiao_id == 4 || this.regiao_id && this.regiao_id == 5 ? 'lista-trabalho-expocom'
                ...
                scroll: false,
                regiao_search: null,
                regiao: this.regiao_id && this.regiao_id == null || this.regiao_id == undefined
                    ? [
                    ...
                    : this.regiao_id && this.regiao_id == 5
                    ?[
                        { id: "Norte" , descricao: "Norte"},
                    ]
                    : this.regiao_id && this.regiao_id == 4
                    ? [
                        { id: "Centro-Oeste" , descricao: "Centro-Oeste"}
                    ] : null
                ,
        ...
        async created() {
            if(this.regiao_id && this.regiao_id == 5){
                this.regiao_search = "Norte"
            }
            else if(this.regiao_id && this.regiao_id == 4){
                this.regiao_search = "Centro-Oeste"  
            }
            else{
                this.regiao_search = "Sudeste"
            }
