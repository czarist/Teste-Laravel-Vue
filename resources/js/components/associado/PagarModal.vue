              ...
              <b-card-text>
                <div class="container">
                  <div class="section-head style-3 text-center z mb-3">
                    <h2 class="title">
                      Checkout <img :src="url + '/images/pagseguro.png'" />
                    </h2>
                  ...
                  <div class="hidden">
                    ...
                    >
                      ...
                      <input
                        ...
                        name="enderecoId"
                        id="enderecoId"
                        :value="form.enderecos ? form.enderecos.id : ''"
                      />
                      <input
                        type="hidden"
                        name="cep"
                        id="cep"
                        :value="form.enderecos ? form.enderecos.cep : ''"
                      />
                      <input
                        type="hidden"
                        name="estado"
                        id="estado"
                        :value="form.enderecos ? form.enderecos.estado : ''"
                      />
                      <input
                        type="hidden"
                        name="logradouro"
                        id="logradouro"
                        :value="form.enderecos ? form.enderecos.logradouro : ''"
                      />
                      <input
                        type="hidden"
                        name="numero"
                        id="numero"
                        :value="form.enderecos ? form.enderecos.numero : ''"
                      />
                      <input
                        type="hidden"
                        name="bairro"
                        id="bairro"
                        :value="form.enderecos ? form.enderecos.bairro : ''"
                      />
                      <input
                        type="hidden"
                        name="complemento"
                        id="complemento"
                        :value="
                          form.enderecos ? form.enderecos.complemento : ''
                        "
                      />
                      <input
                        type="hidden"
                        ...
                        id="municipio"
                        :value="
                          form.enderecos ? form.enderecos.municipio.id : ''
                        "
                      />
                      <input
                        type="hidden"
                        name="pais"
                        id="pais"
                        :value="form.enderecos ? form.pais : ''"
                      />
                    </form>
                  </div>
                </div>
