<template>
    <div class="mt-4">
                        ...
                        <table class="table table-sm table-striped table-hover table-bordered" v-if="user">
                            ...
                            <tbody>
                                <tr v-for="(registro, index) in registros" :key="index">
                                    ...
                                    <td class="align-middle text-center">{{ registro ? registro.categoria : "NI" }}</td>
        ...
        <form-categoria @store="store($event)" @update="update($event)" :selected="selected"></form-categoria>
...
<script>
    ...
    export default {
        mixins: [GridMixin],
        components: {
            FormCategoria: () => import('./FormCategoria' /* webpackChunkName: "form-categoria" */),
        ...
        methods: {
            showForm(registro) {
                ...
                this.$bvModal.show('categoriaModal')
            },
            showDelete(registro) {
            ...
            store($event) {
                ...
                this.$bvModal.hide('categoriaModal')
                this.total++
            },
            update($event) {
