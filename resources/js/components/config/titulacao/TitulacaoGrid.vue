<template>
    <div class="mt-4">
                        ...
                        <table class="table table-sm table-striped table-hover table-bordered" v-if="user">
                            <thead>
                                <tr>
                                    <th
                                        ...
                                        width="40%"
                                        @click="handleSort('titulacao')">
                                        <i class="fas" :class="{
                                            'fa-sort' : sort!= 'titulacao',
                                            'fa-sort-up' : sort== 'titulacao' && asc == true,
                                            'fa-sort-down' : sort== 'titulacao' && asc == false
                                        }"></i> Titulação 
                                    </th>
                            ...
                            <tbody>
                                <tr v-for="(registro, index) in registros" :key="index">
                                    <td class="align-middle text-center">{{ registro ? registro.titulacao : "NI" }}</td>
        ...
        <form-titulacao @store="store($event)" @update="update($event)" :selected="selected"></form-titulacao>
...
<script>
    ...
    export default {
        mixins: [GridMixin],
        components: {
            FormTitulacao: () => import('./FormTitulacao' /* webpackChunkName: "form-titulacao" */),
        ...
        methods: {
            showForm(registro) {
                ...
                this.$bvModal.show('titulacaoModal')
            },
            showDelete(registro) {
            ...
            store($event) {
                ...
                this.$bvModal.hide('titulacaoModal')
                this.total++
            },
            update($event) {
