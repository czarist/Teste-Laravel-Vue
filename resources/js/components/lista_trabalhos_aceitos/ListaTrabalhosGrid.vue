<template>
    <div class="mt-5">
        <h5 class="col-12 d-flex justify-content-between">
            Lista de Trabalhos - DT, IJ e MESA {{ regiao_nome ? regiao_nome : '' }}
        </h5>
        <div class="col-12">
            <div class="card">
                        ...
                        <table class="table table-sm table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(registro, index) in registros" :key="index">
                                    ...
                                    <td class="align-middle text-center" >{{ registro && registro.titulo ? registro.titulo.substring(50, 0) : "NI" }}</td>
