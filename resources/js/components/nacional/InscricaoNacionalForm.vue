        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center">
                    <h1>FICHA DE INSCRIÇÃO - NACIONAL</h1>
                </div>
            </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <b-row>
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="!user.pago_nacional_2022">
                                        ...
                                        <tr v-for="(produtoRegional, index) in produtosRegionais" :key="index">
                                            ...
                                            >
                                                <b-form-checkbox
                                                    ...
                                                    :disabled="produtoRegional && produtoRegional.id == 28 && user.anuidade_2022 == false ? true : loading"
                                                    v-validate="{ required: true }"
                                                    >
                                                </b-form-checkbox>
                                            </td>
                        ...
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="user.pago_nacional_2022 == true">
                            <div>
                                <b-alert show variant="success">
                                    <h4 class="alert-heading">Você já esta inscrito no Nacional 2022!</h4>
                                    <p>
                                    Já foi inscrito pelo nosso sistema para o Nacional 2022.
                                    </p>
                                </b-alert>
                            </div>
                        </b-col>
                            ...
                            <div class="table-responsive scroll" ref="scroll" v-show="!loading && produtosRegionais.length > 0">
                                <table class="table table-sm table-striped table-hover table-bordered" v-if="user">
                                    <thead>
                                        <tr>
                                            <th class="align-middle text-center" width="60%">CATEGORIAS</th>
                                            <th class="align-middle text-center" width="10%">De 15/04 a 05/06/2022</th>
                                            <th class="align-middle text-center" width="10%">De 06/06 a 08/07/2022</th>
                                            <th class="align-middle text-center" width="10%">De 09/07/2022 a 12/08/2022</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr >
                                            <td class="align-middle text-center">Estudante de graduação e recém-graduado (2021-2022) ²</td>
                                            <td class="align-middle text-center">R$130,00</td>
                                            <td class="align-middle text-center">R$160,00</td>
                                            <td class="align-middle text-center">R$185,00</td>
                                        </tr>
                                        <tr >
                                        ...
                                        <tr >
                                            ...
                                            <td class="align-middle text-center">R$300,00</td>
                                            <td class="align-middle text-center">R$320,00</td>
                                            <td class="align-middle text-center">R$350,00</td>
                                        </tr>
                                        <tr >
                                            <td class="align-middle text-center">Professores, pesquisadores e profissionais da área</td>
                                            <td class="align-middle text-center">R$350,00</td>
                                            <td class="align-middle text-center">R$430,00</td>
                                            <td class="align-middle text-center">R$515,00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
      ...
      export default {
        ...
        watch: {
            user(){
                if(this.user){
                    ...
                    this.post.titulacao_id = this.user && this.user.nacional ? this.user.nacional.categoria_inscricao : null

                    this.post.guard_sab = this.user && this.user.nacional ? this.user.nacional.guardador_sabado : null
                    this.post.port_nece = this.user && this.user.nacional ? this.user.nacional.port_nece_espe : null
                    this.post.qual = this.user && this.user.nacional ? this.user.nacional.port_nece_espe_qual : null
                    this.post.outra_necessidade = this.user && this.user.nacional ? this.user.nacional.port_nece_espe_outra : null
                    ...
                    this.post.endereco = {
                        ...
                        estado:
                            ...
                            : null,
                        pais: this.user && this.user.enderecos && this.user.enderecos[0] ? this.user.enderecos[0].pais_id : null
                    }
                }
            },
        ...
        methods: {  
            ...
            async getProdutosRegionais() {
                let urlgetProdutosRegionais = this.baseUrl+"/get/produtos-nacional";
            ...
            async save() {
                ...
                await this.$validator.validateAll().then((valid) => {
                    ...
                    if(valid) {
                        ...
                        if(this.post && this.post.taxa_inscricao && this.post.taxa_inscricao.id == 28 && this.user.anuidade_2022 == false){
                            this.loading = false
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/nacional/save";
