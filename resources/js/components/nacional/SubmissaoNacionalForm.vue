...
<div>
    <div class="row justify-content-center" v-on="this.tipos()" v-show="this.edit">
        <div class="col-md-12">
            ...
            <div class="card mt-3" v-if="post.tipo.numero == 2">
                <div class="card-header text-center">
                        ...
                        <div class="col-12 col-sm-12 col-lg-12 text-center">
                            ...
                            <div class="">
                                <v-select
                                    ...
                                    :selectOnTab="true"
                                    v-model="post.divisoes_tematicas[0]"
            ...
            <div class="card mt-3" v-if="post.tipo.numero == 3">
                <div class="card-header text-center">
                    <h2>Publicom</h2>
                </div>
                ...
                <div class="card-body">
                    <b-row>
                        ...
                        <b-col cols="12" sm="6" lg="6">
                            <b-form-group label="Ano de publicação:" label-class="font-weight-bold">
                                <b-form-input
                                    name="ano"
                                    size="sm"
                                    v-model="post.ano"
                                    ...
                                    aria-describedby="input-1-live-feedback"
                                    data-vv-as="Ano da publicação do trabalho"
                                    v-validate="{ required: true }"
                                ></b-form-input>
                        ...
                        <b-col cols="12" sm="6" lg="6">
                            <b-form-group label="Editora:" label-class="font-weight-bold">
                                <b-form-input
                                    name="editora"
                                    size="sm"
                                    v-model="post.editora"
                                    type="text"
                                    :disabled="loading"
                                    :class="['form-control form-control-sm', {'is-invalid': errors.has(`editora`)}]"
                                    aria-describedby="input-1-live-feedback"
                                    data-vv-as="editora"
                                    v-validate="{ required: true }"
                                ></b-form-input>
                                <span v-show="errors.has(`editora`)" class="invalid-feedback">
                            ...
                            <b-col cols="12" class="d-block w-100 bg-light p-3 mb-3">
                                <b-row>
                                    ...
                                    <b-col cols="12" sm="6" lg="6" class="text-center mb-3">
                                        <b-form-group :label="post.tipo && post.tipo.numero == 3 ? 'Nome completo' : 'Nome completo (eventuais erros sairão no certificado)'" label-class="font-weight-bold">
                                            <b-form-input
                                    ...
                                    <b-col cols="12" sm="3" lg="3" class="text-center mb-3" v-if="post.tipo && post.tipo.numero != 3">
                                    ...
                                    <b-col cols="12" sm="3" lg="3" class="text-center mb-3">
                                        <b-form-group label="Categoria" label-class="font-weight-bold">
                                            ...
                                            >
                                                ...
                                                <option value="2"> {{ post.tipo && post.tipo.numero == 3 ? "Organizador(a)" : "Orientador(a)"}}</option>
                                                <option value="3" v-if="post.tipo && post.tipo.numero == 3">Autor(a)</option>
                                            </b-form-select>
    ...
    import MixinsGlobal from  '../mixins/global-mixins'
      ...
      export default {
        ...
        data() {
            return {
                ...
                post: {
                    ...
                    divisoes_tematicas: this.submissao && this.submissao.dt ? [ this.submissao.dt]  : [],
                    ...
                    coautoresOrientadores: 
                        ...
                        && this.submissao.coautor_orientador_sub_centrooeste.length == 0 ?
                    [{
                        id: null,
                        nome_completo: null,
                        categoria: null,
        ...
        watch: {
            user(){
                if(this.user){
                    ...
                    this.post.ciente = this.submissao ? this.submissao.ciente : 1
        ...
        methods: {  
                    ...
                    if(valid) {                        
                        if(this.generateErr == true){
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/submissao/nacional/save";
            ...
            visualizarAnexo(){
                window.open(this.baseUrl+'/pdf/submissao_nacional_2022/'+this.post.file);
            },
            removeCoaOri(index){
            ...
            tipos(){
                if(this.tipo){
                    ...
                    if(this.tipo == 2){
                        this.post.tipo.numero = this.tipo
                        this.post.tipo.name = "Grupo de Pesquisa"
                    }
                    if(this.tipo == 3){
                        this.post.tipo.numero = this.tipo
                        this.post.tipo.name = "Publicom"
                    }
                }
                if(this.regiao){
                    if(this.regiao == 1){
        ...
        mounted(){
            if(this.user){
                if(this.user && this.user.nacional && this.user.nacional.submissao_publicom && this.tipo == 3){
                    this.submissao = this.user.nacional.submissao_publicom
                }

                if(this.user && this.user.nacional && this.user.nacional.submissao_junior && this.tipo == 1){
                    this.submissao = this.user.nacional.submissao_junior
                }

                if(this.user && this.user.nacional && this.user.nacional.submissao_gp && this.tipo == 2){
                    this.submissao = this.user.nacional.submissao_gp
                }
                ...
                if(
                    this.submissao 
                    && this.submissao.coautor_organizadores_sub_naci
                    && this.submissao.coautor_organizadores_sub_naci.length > 0){

                    this.submissao.coautor_organizadores_sub_naci.forEach((element, index) => {
