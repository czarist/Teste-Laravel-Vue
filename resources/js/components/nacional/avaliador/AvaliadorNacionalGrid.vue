<template>
    <div class="mt-4">
        <h5 class="col-12 d-flex justify-content-between">
            Área do avaliador - Avaliação do Trabalho Nacional - GP, IJ e Publicom
        </h5>
        <div class="col-12">
            <div class="card">
        ...
        <status-avaliador-modal :selectedAvaliador="selectedAvaliador" :user="user" :divisoes_tematicas="divisoes_tematicas" :divisoes_tematicas_jr="divisoes_tematicas_jr" :gps="gps"></status-avaliador-modal>
        ...
        methods: {
            ...
            find_dt(registro){
                if(registro && registro.submissao && registro.submissao.dt){
                    ...
                    if(registro && registro.submissao && registro.submissao.tipo == "Grupo de Pesquisa"){
                        let selectedDt =  this.gps.find(gp => gp.id === registro.submissao.dt)
                    ...
                    if(registro && registro.submissao && registro.submissao.tipo == "Intercom Júnior"){
                    ...
                    if(registro && registro.submissao && registro.submissao.tipo == "Publicom"){
            ...
            find_avaliacoes(registro){
                if(registro){
                    if(registro.sub_gp){
                        return registro.submissao = registro.sub_gp
                    }
                    if(registro.sub_ij){
                        return registro.submissao = registro.sub_ij
                    }
                    if(registro.sub_publicom){
                        return registro.submissao = registro.sub_publicom
                    }
                }
            },
            showForm(registro) {
