<template>
    <div class="mt-4">
        <h5 class="col-12 d-flex justify-content-between">
            Área do avaliador - Avaliação do Trabalho Expocom
        </h5>
        <div class="col-12">
            <div class="card">
                            ...
                            <tbody>
                                <tr v-for="(registro, index) in registros" :key="index" v-on="find_avaliacoes(registro)">
                                    ...
                                    <td class="align-middle text-center" >
                                            ...
                                            >
                                                {{ 
                                                    registro && registro.submissao && registro.submissao.inscricao &&
                                                    registro.submissao.inscricao.user && registro.submissao.inscricao.user.indicacao ? 
                                                    registro.submissao.inscricao.user.indicacao.titulo_trabalho.substring(50, 0) : "NI" 
                                                }}
                                            </button>
                                    ...
                                    <td class="align-middle text-center">
                                        <button
                                            ...
                                            @click="resetModalChat(),getChat(registro)"
                                            type="button"
        ...
        <status-avaliador-expocom-modal :selectedAvaliador="selectedAvaliador" :user="user"></status-avaliador-expocom-modal>
...
<script>
    ...
    import StatusAvaliadorExpocomModal from './StatusAvaliadorExpocomModal.vue'
    ...
    export default {
        mixins: [GridMixin],
        components: {
            StatusAvaliadorExpocomModal:() => import('./StatusAvaliadorExpocomModal.vue'),
        ...
        methods: {
            ...
            find_dt(registro){
                if(registro && registro.submissao && registro.submissao.inscricao &&  registro.submissao.inscricao.categoria_inscricao){
                    let selectedDt =  this.divisoes_tematicas.find(dt => dt.id === registro.submissao.inscricao.categoria_inscricao)
