    ...
    import MixinsGlobal from  '../../mixins/global-mixins'
      ...
      export default {
        ...
        methods: {  
                    ...
                    if(valid) {                        
                        if(this.generateErr == true){
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/submissao/centrooeste/save";
            ...
            visualizarAnexo(){
                window.open(this.baseUrl+'/pdf/submissao_regional_centrooeste_2022/'+this.post.file);
            },
            removeCoaOri(index){
        ...
        mounted(){
            if(this.user){
                ...
                if(this.user && this.user.regional_centrooeste && this.user.regional_centrooeste.submissao_junior && this.tipo == 1){
                    this.submissao = this.user.regional_centrooeste.submissao_junior
                }

                if(this.user && this.user.regional_centrooeste && this.user.regional_centrooeste.submissao_mesa && this.tipo == 3){
                    this.submissao = this.user.regional_centrooeste.submissao_mesa
                }
                ...
                if(
                    ...
                    this.submissao.coautor_orientador_sub_centrooeste.forEach((element, index) => {
