        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center">
                    <h1>Encontro Inter-regiões - Nordeste</h1>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <b-row>
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="!user.pago_regional_nordeste_2022">
                        ...
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="user.pago_regional_nordeste_2022 == true">
                            <div>
                                <b-alert show variant="success">
                                    <h4 class="alert-heading">Você já esta inscrito no Reginal Nordeste!</h4>
                                    <p>
                                    Já foi inscrito pelo nosso sistema para o Regional Nordeste 2022.
                                    </p>
                                </b-alert>
                            </div>
                        </b-col>
      ...
      export default {
        ...
        watch: {
            user(){
                if(this.user){
                    ...
                    this.post.titulacao_id = this.user && this.user.regional_nordeste ? this.user.regional_nordeste.categoria_inscricao : null
                    this.post.numero_matricula = this.user && this.user.regional_nordeste ? this.user.regional_nordeste.numero_matricula : null

                    this.post.guard_sab = this.user && this.user.regional_nordeste ? this.user.regional_nordeste.guardador_sabado : null
                    this.post.port_nece = this.user && this.user.regional_nordeste ? this.user.regional_nordeste.port_nece_espe : null
                    this.post.qual = this.user && this.user.regional_nordeste ? this.user.regional_nordeste.port_nece_espe_qual : null
                    this.post.outra_necessidade = this.user && this.user.regional_nordeste ? this.user.regional_nordeste.port_nece_espe_outra : null
        ...
        methods: {  
            ...
            async getProdutosRegionais() {
                let urlgetProdutosRegionais = this.baseUrl+"/get/produtos-regionais-nordeste";
                    ...
                    if(valid) {
                        ...
                        if(this.post && this.post.taxa_inscricao && this.post.taxa_inscricao.id == 4 && this.user.anuidade_2022 == false){
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/regional/nordeste/save";
