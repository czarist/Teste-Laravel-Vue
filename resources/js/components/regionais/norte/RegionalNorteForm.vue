        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center">
                    <h1>Encontro Inter-regiões - Norte</h1>
                    ...
                    <b-row>
                        ...
                        <b-col cols="12" sm="6" lg="6">
                            <b-form-group label="Titulação" label-class="font-weight-bold">
                                <b-form-select
                                    :disabled="user && user.pago_regional_norte_2022 && post && post.titulacao_id != null ? true : loading" 
                                    name="titulacao"
                                    v-validate="{ required: true }"
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <b-row>
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="!user.pago_regional_norte_2022">
                        ...
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="user.pago_regional_norte_2022 == true">
                            <div>
                                <b-alert show variant="success">
                                    <h4 class="alert-heading">Você já esta inscrito no Reginal Norte!</h4>
                                    <p>
                                    Já foi inscrito pelo nosso sistema para o Regional Norte 2022.
                                    </p>
                                </b-alert>
                            </div>
                        </b-col>
                            ...
                            <div class="table-responsive scroll" ref="scroll" v-show="!loading && produtosRegionais.length > 0">
                                <table class="table table-sm table-striped table-hover table-bordered" v-if="user">
                                    <thead>
                                        <tr>
                                            <th class="align-middle text-center" width="60%">CATEGORIAS</th>
                                            <th class="align-middle text-center" width="10%">De 14/03 a 17/04/2022</th>
                                            <th class="align-middle text-center" width="10%">De 18/04 a 06/05/2022</th>
                                            <th class="align-middle text-center" width="10%">De 07/05 a 17/05/2022</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr >
                        ...
                        <div class="col d-flex justify-content-end">
                            ...
                            <div v-if="user.anuidade_2022 == false">
                                <b-button
                                    ...
                                    :disabled="user && user.pago_regional_norte_2022 ? true : loading" 
                                    size="md" 
      ...
      export default {
        ...
        data() {
            return {
                ...
                now: moment().format('L') >= '05/18/2022' ? true : false,
                selectedPagar: null,
        ...
        watch: {
            user(){
                if(this.user){
                    ...
                    this.post.titulacao_id = this.user && this.user.regional_norte ? this.user.regional_norte.categoria_inscricao : null

                    this.post.guard_sab = this.user && this.user.regional_norte ? this.user.regional_norte.guardador_sabado : null
                    this.post.port_nece = this.user && this.user.regional_norte ? this.user.regional_norte.port_nece_espe : null
                    this.post.qual = this.user && this.user.regional_norte ? this.user.regional_norte.port_nece_espe_qual : null
                    this.post.outra_necessidade = this.user && this.user.regional_norte ? this.user.regional_norte.port_nece_espe_outra : null
        ...
        methods: {  
            ...
            async getProdutosRegionais() {
                let urlgetProdutosRegionais = this.baseUrl+"/get/produtos-regionais-norte";
                    ...
                    if(valid) {                        
                        if(this.post && this.post.taxa_inscricao && this.post.taxa_inscricao.id == 4 && this.user.anuidade_2022 == false){
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/regional/norte/save";
