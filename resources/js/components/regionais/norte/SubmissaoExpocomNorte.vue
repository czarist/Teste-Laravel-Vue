      ...
      export default {
        ...
        data() {
            return {
                ...
                post: {
                    id: this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.id : null,
                    titulo: this.indicacao ? this.indicacao.titulo_trabalho : null,
                    ano: this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.ano : null,
                    instituicao_id: this.indicacao ? this.indicacao.instituicao_id : null,
                    campus: this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.campus : null,
                    categoria: this.indicacao ? this.indicacao.categoria : null,
                    desc_obj_estudo: this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.desc_obj_estudo : null,
                    desc_pesquisa: this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.desc_pesquisa : null,
                    desc_producao: this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.desc_producao : null,
                    file: this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.link_trabalho : null,
                    ...
                    coautoresOrientadores: 
                        ...
                        && this.user.regional_norte.submissao_expocom.coautor_orientador_sub_nortes
                        && this.user.regional_norte.submissao_expocom.coautor_orientador_sub_nortes.length == 0 ?
                    [{
                        id: null,
                        nome_completo: null,
                        categoria: null,
        ...
        watch: {
            user(){
                if(this.user){
                    ...
                    this.post.id = this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.id : null
                    this.post.ano = this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.ano : null
                    this.post.desc_obj_estudo = this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.desc_obj_estudo : null
                    this.post.desc_pesquisa = this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.desc_pesquisa : null
                    this.post.desc_producao = this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.desc_producao : null
                    this.post.campus = this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.campus : null
                    this.post.file = this.user && this.user.regional_norte && this.user.regional_norte.submissao_expocom ? this.user.regional_norte.submissao_expocom.link_trabalho : null
                }
            },
            indicacao(){
                if(this.indicacao){
        ...
        methods: {  
                    ...
                    if(valid) {                        
                        if(
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/submissaoexpocom/norte/save";
            ...
            visualizarAnexo(){
                window.open(this.baseUrl+'/pdf/submissao_expocom_regional_norte_2022/'+this.post.file);
            },
            addCoaOri(){
        ...
        mounted(){
            if(this.user){
                if(
                    ...
                    this.user.regional_norte.submissao_expocom.coautor_orientador_sub_nortes.forEach((element, index) => {
