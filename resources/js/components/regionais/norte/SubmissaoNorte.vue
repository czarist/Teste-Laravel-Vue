...
<div v-else class="text-center">
    <h1>Prazo para submissão norte encerrado</h1>
</div>
    ...
    import MixinsGlobal from  '../../mixins/global-mixins'
      ...
      export default {
        ...
        data() {
            return {
                ...
                post: {
                    ...
                    ciente: this.submissao ? this.submissao.ciente : 0,
        ...
        methods: {  
                    ...
                    if(valid) {                        
                        if(this.generateErr == true){
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/submissao/norte/save";
            ...
            visualizarAnexo(){
                window.open(this.baseUrl+'/pdf/submissao_regional_norte_2022/'+this.post.file);
            },
            removeCoaOri(index){
        ...
        mounted(){
            if(this.user){
                ...
                if(this.user && this.user.regional_norte && this.user.regional_norte.submissao_dt && this.tipo == 2){
                    this.submissao = this.user.regional_norte.submissao_dt
                }

                if(this.user && this.user.regional_norte && this.user.regional_norte.submissao_junior && this.tipo == 1){
                    this.submissao = this.user.regional_norte.submissao_junior
                }

                if(this.user && this.user.regional_norte && this.user.regional_norte.submissao_mesa && this.tipo == 3){
                    this.submissao = this.user.regional_norte.submissao_mesa
                }
                ...
                if(
                    this.submissao 
                    && this.submissao.coautor_orientador_sub_nortes
                    && this.submissao.coautor_orientador_sub_nortes.length > 0){

                    this.submissao.coautor_orientador_sub_nortes.forEach((element, index) => {
