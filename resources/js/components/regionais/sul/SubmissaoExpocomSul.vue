        ...
        data() {
            return {
                ...
                post: {
                    ...
                    ciente:  this.user && this.user.regional_sul && this.user.regional_sul.submissao_expocom ? this.user.regional_sul.submissao_expocom.ciente : 0,
                    enderecos: {
                        estado: null,
                        municipio: null
                    },
                    ...
                    if(valid) {                        
                        if(
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/submissaoexpocom/sul/save";
