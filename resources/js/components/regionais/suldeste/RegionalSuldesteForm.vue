    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
                    ...
                    <b-row>
                        ...
                        <b-col cols="12" sm="6" lg="6">
                            <b-form-group label="Titulação" label-class="font-weight-bold">
                                <b-form-select
                                    :disabled="user && user.pago_regional_suldeste_2022 && post && post.titulacao_id != null ? true : loading" 
                                    name="titulacao"
                                    v-validate="{ required: true }"
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <b-row>
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="user.pago_regional_suldeste_2022 == false">
                        ...
                        <b-col cols="12" sm="12" lg="12" size="lg" v-if="user.pago_regional_suldeste_2022 == true">
                            <div>
                                <b-alert show variant="success">
                                    <h4 class="alert-heading">Você já esta inscrito no Reginal Sudeste!</h4>
                                    <p>
                                    Já foi inscrito pelo nosso sistema para o Regional Sudeste 2022.
                                    </p>
                                </b-alert>
                            </div>
                        </b-col>
                    ...
                    <div class="row">
                        <div class="col d-flex justify-content-end">
                            ...
                            <div v-if="user.anuidade_2022 == false">
                                <b-button
                                    v-if="user.pago_regional_suldeste_2022 == false"
                                    :disabled="user && user.pago_regional_suldeste_2022 ? true : loading" 
                                    size="md" 
      ...
      export default {
        ...
        data() {
            return {
                ...
                now: moment().format('L') >= '05/11/2022' ? true : false,
                selectedPagar: null,
        ...
        watch: {
            user(){
                if(this.user){
                    ...
                    this.post.titulacao_id = this.user && this.user.regional_suldeste ? this.user.regional_suldeste.categoria_inscricao : null

                    this.post.guard_sab = this.user && this.user.regional_suldeste ? this.user.regional_suldeste.guardador_sabado : null
                    this.post.port_nece = this.user && this.user.regional_suldeste ? this.user.regional_suldeste.port_nece_espe : null
                    this.post.qual = this.user && this.user.regional_suldeste ? this.user.regional_suldeste.port_nece_espe_qual : null
                    this.post.outra_necessidade = this.user && this.user.regional_suldeste ? this.user.regional_suldeste.port_nece_espe_outra : null
        ...
        methods: {  
            ...
            async getProdutosRegionais() {
                let urlgetProdutosRegionais = this.baseUrl+"/get/produtos-regionais-suldeste";
                    ...
                    if(valid) {
                        ...
                        if(this.post && this.post.taxa_inscricao && this.post.taxa_inscricao.id == 4 && this.user.anuidade_2022 == false){
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/regional/suldeste/save";
