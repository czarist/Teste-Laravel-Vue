...
<div div v-if="this.user.regional_suldeste.submissao_expocom != null">
      ...
      export default {
        ...
        data() {
            return {
                ...
                edit: this.user && this.user.regional_suldeste && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? false : true,
                ciente: false,
                indicacao: [],
                titulacoes: [],
                instituicoes: [],
                ...
                post: {
                    id: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.id : null,
                    titulo: this.indicacao ? this.indicacao.titulo_trabalho : null,
                    ano: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.ano : null,
                    instituicao_id: this.indicacao ? this.indicacao.instituicao_id : null,
                    campus: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.campus : null,
                    categoria: this.indicacao ? this.indicacao.categoria : null,
                    desc_obj_estudo: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.desc_obj_estudo : null,
                    desc_pesquisa: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.desc_pesquisa : null,
                    desc_producao: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.desc_producao : null,
                    file: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.link_trabalho : null,
                    modalidade: this.indicacao ? this.indicacao.modalidade : null,
                    termo_autoria: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.termo_autoria : 0,
                    autorizacao: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.autorizacao : 0,
                    ciente: this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.ciente : 0,
                    ...
                    coautoresOrientadores: 
                        ...
                        && this.user.regional_suldeste.submissao_expocom.coautor_orientador_sub_sudeste
                        && this.user.regional_suldeste.submissao_expocom.coautor_orientador_sub_sudeste.length == 0 ?
                    [{
                        id: null,
                        nome_completo: null,
                        categoria: null,
        ...
        watch: {
            user(){
                if(this.user){
                    ...
                    this.post.id = this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.id : null
                    this.post.ano = this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.ano : null
                    this.post.desc_obj_estudo = this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.desc_obj_estudo : null
                    this.post.desc_pesquisa = this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.desc_pesquisa : null
                    this.post.desc_producao = this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.desc_producao : null
                    this.post.campus = this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.campus : null
                    this.post.file = this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_expocom ? this.user.regional_suldeste.submissao_expocom.link_trabalho : null
                }
            },
            indicacao(){
                if(this.indicacao){
        ...
        methods: {  
                    ...
                    if(valid) {                        
                        if(
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/submissaoexpocom/suldeste/save";
            ...
            visualizarAnexo(){
                window.open(this.baseUrl+'/pdf/submissao_expocom_regional_suldeste_2022/'+this.post.file);
            },
            addCoaOri(){
        ...
        mounted(){
            if(this.user){
                if(
                    ...
                    this.user.regional_suldeste.submissao_expocom.coautor_orientador_sub_sudeste.forEach((element, index) => {
