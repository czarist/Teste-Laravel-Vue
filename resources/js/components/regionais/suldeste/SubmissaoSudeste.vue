    ...
    import MixinsGlobal from  '../../mixins/global-mixins'
      ...
      export default {
        ...
        methods: {  
                    ...
                    if(valid) {                        
                        if(this.generateErr == true){
                            ...
                            setTimeout(() => {
                                ...
                                let urlSave = this.baseUrl+"/submissao/suldeste/save";
            ...
            visualizarAnexo(){
                window.open(this.baseUrl+'/pdf/submissao_regional_suldeste_2022/'+this.post.file);
            },
            removeCoaOri(index){
        ...
        mounted(){
            if(this.user){
                ...
                if(this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_dt && this.tipo == 2){
                    this.submissao = this.user.regional_suldeste.submissao_dt
                }

                if(this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_junior && this.tipo == 1){
                    this.submissao = this.user.regional_suldeste.submissao_junior
                }

                if(this.user && this.user.regional_suldeste && this.user.regional_suldeste.submissao_mesa && this.tipo == 3){
                    this.submissao = this.user.regional_suldeste.submissao_mesa
                }
                ...
                if(
                    this.submissao 
                    && this.submissao.coautor_orientador_sub_sudeste
                    && this.submissao.coautor_orientador_sub_sudeste.length > 0){

                    this.submissao.coautor_orientador_sub_sudeste.forEach((element, index) => {
