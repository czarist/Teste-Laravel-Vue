...
<body style="margin: 0">
    ...
    <div id="mensagem" style="border: solid #3A48E5 1px">
        ...
        <div id="corpo" style="background: #f5f9fb; color: 5F5C5C; padding: 30px; font-size: 14px; font-family: Arial; line-height: 24px;">
			...
			Você foi selecionado como avaliador de trabalho(s) das DTs, IJ e/ou Mesa. Para ter acesso aos trabalhos, acesse sua área de avaliador em sistemas.intercom.org.br. Todas as orientações estão no chat, junto ao(s) trabalho(s) designados.
