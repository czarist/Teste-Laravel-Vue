...
<body style="margin: 0; {{$certificado['image']}}">
    <div class="main">
        ...
        @endif
            ...
            INTERCOM e realizado pela Universidade Católica de Salvador - UCSAL, entre os dias 18 e 20 de maio, na Cidade de Salvador/BA, como Vencedor(a) do PRÊMIO EXPOCOM - 
