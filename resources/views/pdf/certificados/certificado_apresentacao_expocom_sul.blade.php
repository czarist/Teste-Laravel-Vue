...
<body style="margin: 0; {{$certificado['image']}}">
    <div class="main">
        ...
        @endif
            ...
            participou do XXI Congresso de Ciências da Comunicação na Região {{$certificado['regiao']}}, promovido pela Sociedade Brasileira de Estudos Interdisciplinares da 
            Comunicação - INTERCOM e realizado pela Univali - Universidade do Vale do Itajaí, entre os dias 16 a 18 de junho, na Cidade de Balneário Camboriú/SC, como 
