...
<body style="margin: 0; {{$certificado['image']}}">
    <div class="main">
        ...
        @endif
            ...
            participou do XXV Congresso de Ciências da Comunicação na Região {{$certificado['regiao']}}, promovido pela Sociedade Brasileira de Estudos Interdisciplinares da 
