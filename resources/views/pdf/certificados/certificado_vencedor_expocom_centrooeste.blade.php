...
<body style="margin: 0; {{$certificado['image']}}">
    <div class="main">
        ...
        @endif
            ...
            INTERCOM e realizado pela UFMT - Universidade Federal de Mato Grosso(evento integralmente online), entre os dias 9 a 11 de junho, na Cidade de Cuiabá e Barra do Garças/MT, como Vencedor(a) do PRÊMIO EXPOCOM - 
