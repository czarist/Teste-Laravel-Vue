...
<body style="margin: 0">
    <div style="main">
            ...
            <div align="center" style="text-align: justify !important;">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <strong>{{ $recibo['numero_congresso']}}</strong>. <br>
        ...
        <div align="center" class="footer" style="background: #38acbc; color: #FFF; font-size: 11px; font-family: DejaVu Sans; line-height: 20px;">
            <strong>
