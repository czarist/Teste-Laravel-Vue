...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('certificados/certificado_apresentacao_expocom_coautor/pdf/{user_id}/{submissao}/{regiao}', [CertificadosController::class, 'certificado_apresentacao_expocom_coautor'])->name('certificados.certificado_apresentacao_expocom_coautor');
    Route::get('certificados/certificado_vencedor_expocom_coautor/pdf/{user_id}/{submissao}/{regiao}', [CertificadosController::class, 'certificado_vencedor_expocom_coautor'])->name('certificados.certificado_vencedor_expocom_coautor');
    ...
    Route::get('certificados/certificado_apresentacao_coautor/pdf/{user}/{submissao}/{regiao}', [CertificadosController::class, 'certificado_apresentacao_coautor'])->name('certificados.apresentacao.coautor');

    Route::get('certificados/certificado_parecerista_expocom/pdf/{user_id}/{regiao}', [CertificadosController::class, 'certificado_parecerista_expocom'])->name('certificados.parecerista.expocom');
    Route::get('certificados/certificado_parecerista/pdf/{user_id}/{regiao}', [CertificadosController::class, 'certificado_parecerista'])->name('certificados.parecerista');
    ...
    //CHAT NACIONAL AUTOR E COORDENADOR
    Route::get('coordenador/nacional/get/chat/{id}', [ChatAvaliacaoController::class, 'getChatNacional'])->name('chatcoordenador.nacional.get.chat');
    Route::post('coordenador/nacional/send/message', [ChatAvaliacaoController::class, 'sendMensagemNacional'])->name('chatcoordenador.nacional.send.message');
    
    //CHAT ENTRE COORDENADOR E AVALIADOR NACIONAL
